...
public class FileUploadRenderer extends CoreRenderer {
    ...
    protected void encodeAdvancedMarkup(FacesContext context, FileUpload fileUpload) throws IOException {
        ...
        String onchange = fileUpload.getOnchange();
        ...
        //choose button
        encodeChooseButton(context, fileUpload, disabled, onchange);
    ...
    protected void encodeSimpleMarkup(FacesContext context, FileUpload fileUpload) throws IOException {
        ...
        if (fileUpload.isSkinSimple()) {
            ...
            encodeInputField(context, fileUpload, fileUpload.getClientId(context) + "_input", onchange);
            ...
            encodeSimpleInputField(context, fileUpload, fileUpload.getClientId(context), style, onchange, styleClass);
        }
    }

    protected void encodeChooseButton(FacesContext context, FileUpload fileUpload, boolean disabled, String onchange) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
        String clientId = fileUpload.getClientId(context);
        ...
        if (!disabled) {
            encodeInputField(context, fileUpload, clientId + "_input", onchange);
        }

        writer.endElement("span");
    }

    protected void encodeInputField(FacesContext context, FileUpload fileUpload, String clientId, String onchange) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
    ...
    protected void encodeSimpleInputField(FacesContext context, FileUpload fileUpload, String clientId, String style, String onchange, String styleClass) throws IOException {
        ResponseWriter writer = context.getResponseWriter();
        ...
        if (onchange != null) writer.writeAttribute("onchange", onchange, "onchange");
